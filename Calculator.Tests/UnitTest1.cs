...
namespace Calculator.Tests
{
    public class CalcTests
    {
        ...
        {
            var calc = new ParserCalc();
            var res = calc.calculate("2 + 5");
        ...
        {
            var calc = new ParserCalc();
            var res = calc.calculate("8+2*10+3");
            Assert.Equal("31", res);
        }
        ...
        {
            var calc = new ParserCalc();
            var res = calc.calculate("10/3*6+3");
            Assert.Equal("23", res);
        }
        [Fact]
        ...
        {
            var calc = new ParserCalc();
            var res = calc.calculate("10+20*2/4-10*2,5");
            Assert.Equal("-5", res);
        }
        [Fact]
        ...
        {
            var calc = new ParserCalc();
            var res = calc.calculate("4+(2+3)* 4 / ( 10 - 5)");
            Assert.Equal("8", res);
        }
        [Fact]
        ...
        {
            var calc = new ParserCalc();
            var res = calc.calculate("((4))+(2*3)-(1+2)*3-(10/((7-2)-1))");
